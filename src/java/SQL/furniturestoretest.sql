...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2019 at 05:20 PM
...
CREATE TABLE `address` (
  ...
  `streetline1` varchar(60) NOT NULL,
  `streetline2` varchar(60) DEFAULT NULL,
...
INSERT INTO `address` (`addressId`, `houseNo`, `streetline1`, `streetline2`, `town`, `county`, `country`, `postcode`) VALUES
(1, 26, 'Vincent Avenue', '', 'Dundalk', 'Louth', 'Ireland', '0000');
...
INSERT INTO `useraddress` (`userAddressId`, `email`, `addressId`, `defaultAddress`) VALUES
(1, 'audrius@gmail.com', 1, 1);
